...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "pk~zxJWQYxK#oU_7hoTiCkdCPidCywmTr3OmptjydVdzkQ1-rDzWJag",
AUTO_STATUS_SEEN: process.env.AUTO_STATUS_SEEN || "true",
AUTO_STATUS_REPLY: process.env.AUTO_STATUS_REPLY || "false",
AUTO_STATUS_REACT: process.env.AUTO_STATUS_REACT || "true",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "𝐧𝐢𝐥𝐢𝐩𝐞 𝐤𝐰𝐚 𝐤𝐮𝐯𝐢𝐞𝐰 𝐬𝐭𝐚𝐭𝐮𝐬 𝐲𝐚𝐤𝐨 𝐰𝐚𝐤𝐰𝐚𝐧𝐳𝐚😁😅",
...
BOT_NAME: process.env.BOT_NAME || "𝐃𝐚𝐫𝐤 𝐣𝐨𝐤𝐞𝐫",
STICKER_NAME: process.env.STICKER_NAME || "PK-XMD",
CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
DELETE_LINKS: process.env.DELETE_LINKS || "true",
OWNER_NUMBER: process.env.OWNER_NUMBER || "254791747029",
...
AUTO_VOICE: process.env.AUTO_VOICE || "𝐭𝐫𝐮𝐞",
